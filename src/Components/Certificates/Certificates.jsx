        ...
        <div className='certificates'>
            <div className='cert-txt'>
                ...
                <ul className='cert-info'>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='ov-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='ev-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='wild-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='md-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='cs-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
                    ...
                    <li className='cert-info-item'>
                        <div className='cert-svg-box'>
                            <svg className='sm-navshield navshield' viewBox='0 0 27 32'>
                                <path
                                    d="M2.935 3.425l-2.204.04-.225 2.163C-.587 16.326 2.911 25.146 12.15 31.041l1.35.862 1.35-.862c9.239-5.895 12.737-14.715 11.644-25.413l-.225-2.164-2.204-.039c-3.304-.07-6.43-.822-9.262-2.536L13.5.097 12.197.89C9.365 2.603 6.239 3.356 2.935 3.425zM13.5 29.08l-.403-.256C4.408 23.276 1.988 16.628 3.02 6.583l.062-.652.66-.016c3.622-.07 6.267-.907 9.37-2.784l.388-.24.388.24c3.103 1.877 5.748 2.715 9.37 2.784l.66.016.062.652c1.032 10.045-1.388 16.693-10.077 22.24l-.403.256z">
                                </path>
                            </svg>
