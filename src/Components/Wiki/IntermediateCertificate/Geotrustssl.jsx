...
export default function Geotrustssl() {
    useEffect(() => {
        document.title = 'Промежуточные и корневые сертификаты CA GeoTrust'
    })
    return (
        <>
            <div className="wiki-path">
                ...
                <span className='current'>Промежуточные и корневые сертификаты CA GeoTrust</span>
            </div>
            <div className="wiki-main">
                <h3>Промежуточные и корневые сертификаты CA GeoTrust</h3>
                ...
                <ul className='wiki-guide'>
                    <li>
                        ...
                        <div>
                            <h4 className='term-title' style={{ color: '#23a095' }}>Сертификаты GeoTrust</h4>
                            ...
                            <div>
                                <p className='file-title'>
                                    <span><GrNext /></span>
                                    <span>Файлы GeoTrust DV/OV</span>
                                </p>
                                <p className='download-file'>GeoTrust RSA CA <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-rsa-ca.crt">CRT файл</a> | <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-rsa-ca.txt">TXT файл</a></p>
                                ...
                                <p className='download-file'>GeoTrust RSA DV/OV Bundle <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-rsa-ca-bundle.txt">TXT файл</a></p>
                            </div>
                            <div>
                                <p className='file-title'>
                                    <span><GrNext /></span>
                                    <span>Файлы GeoTrust EV</span>
                                </p>
                                <p className='download-file'>GeoTrust EV RSA CA <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-ev-rsa-ca.crt">CRT файл</a> | <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-ev-rsa-ca.txt">TXT файл</a></p>
                                ...
                                <p className='download-file'>GeoTrust EV Bundle <a href="https://gogetssl-cdn.s3.eu-central-1.amazonaws.com/wiki/geotrust-ev-rsa-ca-bundle.txt">TXT файл</a></p>
                            </div>
                        </div>
                    </li>
                </ul>
