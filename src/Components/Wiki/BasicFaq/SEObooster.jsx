                ...
                <ul className="wiki-guide">
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p>Великолепный SSL для защиты базового домена с неограниченным количеством субдоменов. Он поставляется с неограниченным лицензированием серверов, что означает, что вы можете установить его на любое количество IP-адресов, серверов и устройств без дополнительной платы. Никакой бумажной волокиты и бесплатное переоформление.</p>
                            <div className="cert-pricing">
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p>Multi-Domain SSL предоставляет возможность защитить все ваши домены и поддомены одновременно. Он может иметь до 250 элементов SAN, и каждый элемент SAN может охватывать домен или поддомен. Это SSL с проверкой домена и быстрым процессом выдачи.</p>
                            <div className="cert-pricing">
