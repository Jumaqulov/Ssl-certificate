    ...
    <div className='holder-promos'>
      ...
      <div className='promos promo3'>
        ...
        <p className='promo3-text promos-text'>
          <a href="/product/65">Попробуйте 90-дневную пробную версию</a> SSL-сертификат перед реальной покупкой для проверки работоспособности сертификата. Поддержка 99,9% браузеров и мобильных устройств. Бесплатные повторные выпуски.
        </p>
      </div>
