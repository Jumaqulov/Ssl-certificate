            ...
            <div className='certificates'>
                <div className='cert-txt'>
                    ...
                    <p className='cert-txt-item'>
                        ...
                        <span>sslcerificate.uz является одним из крупнейших поставщиков SSL-сертификатов в мире и принадлежит компании Starlab. Наша цель - сделать использование Всемирной паутины безопасным и защищенным с помощью различных услуг, которые мы предоставляем, таких как SSL-сертификаты, средства защиты от вредоносного ПО и сканеры, печати сайта и коды LEI. В настоящее время мы предоставляем сертификаты доменной, бизнес и расширенной валидации, Wildcard, мультидоменные (SAN), сертификаты с подписью кода и S/MIME.</span>
                    </p>
