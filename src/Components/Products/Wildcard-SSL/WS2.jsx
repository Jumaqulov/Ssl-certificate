    ...
    return (
        <div className='cert-txt'>
            ...
            <p className='cert-txt-item'>
                ...
                <span>Сертификаты Wildcard SSL очень популярны среди всех типов клиентов. Они имеют прочную репутацию экономичных и выгодных продуктов, обеспечивающих защиту неограниченного количества поддоменов в рамках одного доменного имени. Больше не нужно покупать и управлять несколькими отдельными сертификатами. <br /><br />    Большинство сертификатов Wildcard предоставляют неограниченное количество серверных лицензий, что означает, что вы можете установить SSL на все свои серверы и среды.</span>
            </p>
            <br /><br /><br /><br />
